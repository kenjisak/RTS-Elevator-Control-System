...
public class InputFileMaker {
    ...
    public void mkf() {
        ...
        try {
            ...
            for (int i = 0; i < lineCount; i++) {
                ...
                int currentFloor = rand.nextInt(floorCount);
                int nextFloor = rand.nextInt(floorCount);
                while (nextFloor == currentFloor) { nextFloor = rand.nextInt(floorCount); }
    ...
    public static void main(String[] args) {
        InputFileMaker t = new InputFileMaker(30, primary.main.MAX_FLOORS, 10);
        t.mkf();
    }
}