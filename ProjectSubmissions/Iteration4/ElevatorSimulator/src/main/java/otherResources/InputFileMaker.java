...
public class InputFileMaker {
    ...
    public InputFileMaker(int timeVariance, int floorCount, int lineCount) {
        this.currentTime = LocalDateTime.now();
        this.upperBound = timeVariance;
        this.floorCount = floorCount;
        this.lineCount = lineCount;
        this.rand = new Random();
        this.formatter1 = DateTimeFormatter.ofPattern("HH:mm:ss.SSS");
    ...
    public void mkf() {
        ...
        try {
            ...
            for (int i = 0; i < lineCount; i++) {
                ...
                int currentFloor = rand.nextInt(0, floorCount);
                int nextFloor = rand.nextInt(0, floorCount);
                while (nextFloor == currentFloor) { nextFloor = rand.nextInt(0, floorCount); }
    ...
    public static void main(String[] args) {
        InputFileMaker t = new InputFileMaker(30, Constants.MAX_ELEVATORS, 10);
        t.mkf();
    }
}