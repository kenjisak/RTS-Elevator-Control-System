...
/**
 * Represents a Floor entity and will run as a thread
 * The floor reads the initial lines from the input files and sends them as messages to the Scheduler through the Mailbox
 * Each floor
 */
@Getter
@Setter
public class Floor implements Runnable{
     ...
     */
    public void readMessagesForThisFloorFromFile(String filePath){
        try {
    ...
    /**
     * calculates the lowest time in the input file by comparing the timestamps of each line
     * @return: the lowest time in the file
     */
    ...
    public ArrayList<Long> scheduleToSend(){
    ...
    public Long determineFirstInterval(Message firstMessage){
        Message m;
        String stringForBuilding = " 1 down 1 0";
