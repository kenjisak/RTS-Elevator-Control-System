...
//    public static final String FILE_PATH = "/inputFinal.txt";
    public static final String FILE_PATH = "/inputDemo.csv";
    ...
    public static int ELEVATOR_TRAVEL_TIME = 2;//rounded mean from measurements, exact is 1.64 between 1 floor
